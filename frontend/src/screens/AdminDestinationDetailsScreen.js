...
const AdminDestinationDetailsScreen = () => {
  ...
  useEffect(() => {
    if (isDetailsError) {
      ...
      setCoverImg(destination.coverImg)
      setImages(destination.images)
      setMapEmbed(destination.mapEmbed)
    } else {
  ...
  useEffect(() => {
    return () => {
      ...
      dispatch(resetDestinationUpdate())
      dispatch(resetDestinationDelete())
    }
  }, [dispatch])
  ...
  const updateHandler = () => {
    ...
    dispatch(updateDestination({ id: params.id, destinationData }))
  }

  const deleteHandler = () => {
    dispatch(deleteDestination(params.id))
  }
              ...
              <Col xs={12} md={8} xl={9}>
                <Card className='mb-4'>
                  ...
                  <Card.Body>
                    ...
                    <Row className='py-4'>
                      <Button variant='outline-dark' size='md' onClick={updateHandler}>
                        <b>Update Destination</b>
                      </Button>
                      </Row>
                      <Row className='py-4'>
                      <Button variant='outline-danger' size='md' onClick={deleteHandler}>
                        <b>Delete Destination</b>
                      </Button>
                    </Row>
                  </Card.Body>
                </Card>
